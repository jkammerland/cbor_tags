...
in variants whose normal structural outer CBOR shapes are distinct. A composed
codec with its own wire policy must decode the whole variant explicitly. An
opt-in tagged-subclass list supports exact dynamic types behind polymorphic
bases.
