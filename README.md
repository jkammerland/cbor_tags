...
stacks. The `nlohmann/json` test covers the JSON-compatible CBOR subset and
known mismatch cases such as CBOR tags and non-text map keys. The Rust
`cbor-diag` test validates CBOR bytes generated by `cbor_tags` through
