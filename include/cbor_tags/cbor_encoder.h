...
struct encoder : public Encoders<encoder<OutputBuffer, Options, Encoders...>>... {
    ...
    constexpr void encode_major_and_size(std::uint64_t value, byte_type majorType) {
        if (value < 24) {
            ...
            // appender_.multi_append(data_, static_cast<byte_type>(24) | majorType, static_cast<byte_type>(value));
        } else if (value <= 0xFFFF) {
            appender_(data_, static_cast<byte_type>(25) | majorType);
            appender_(data_, static_cast<byte_type>(value >> 8));
            appender_(data_, static_cast<byte_type>(value));
            // appender_.multi_append(data_, static_cast<byte_type>(25) | majorType, static_cast<byte_type>(value >> 8),
            //    static_cast<byte_type>(value));
            ...
            appender_(data_, static_cast<byte_type>(value >> 8));
            appender_(data_, static_cast<byte_type>(value));
            // appender_.multi_append(data_, static_cast<byte_type>(26) | majorType, static_cast<byte_type>(value >> 24),
            //    static_cast<byte_type>(value >> 16), static_cast<byte_type>(value >> 8), static_cast<byte_type>(value));
        } else {
            ...
            appender_(data_, static_cast<byte_type>(value >> 8));
            appender_(data_, static_cast<byte_type>(value));
            // appender_.multi_append(data_, static_cast<byte_type>(27) | majorType, static_cast<byte_type>(value >> 56),
            //                        static_cast<byte_type>(value >> 48), static_cast<byte_type>(value >> 40),
            //                        static_cast<byte_type>(value >> 32), static_cast<byte_type>(value >> 24),
            //                        static_cast<byte_type>(value >> 16), static_cast<byte_type>(value >> 8),
            //                        static_cast<byte_type>(value));
        }
    }
